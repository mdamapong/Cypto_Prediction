(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[4864,7634,9531,8701],{
...
__webpack_require__.d(__webpack_exports__, {
  Bg: () => (/* binding */ jpToolbar)
});

// UNUSED EXPORTS: DelegatesARIAToolbar, FoundationToolbar, Toolbar, toolbarStyles
...
const getDirection = (rootNode) => {
    ...
    return dirNode !== null && dirNode.dir === "rtl" ? localization/* Direction */.N.rtl : localization/* Direction */.N.ltr;
};
 ...
 * @public
 */
const toolbarTemplate = (context, definition) => (0,template/* html */.d) `
    <template
 ...
 * @public
 */
const toolbarStyles = (context, definition) => (0,css/* css */.i) `
    ${(0,display/* display */.j)('inline-flex')} :host {
      --toolbar-item-gap: calc(
        (var(--design-unit) + calc(var(--density) + 2)) * 1px
      );
      background-color: ${design_tokens/* fillColor */.If};
      border-radius: calc(${design_tokens/* controlCornerRadius */.UW} * 1px);
      fill: currentcolor;
      padding: var(--toolbar-item-gap);
    }

    :host(${style_focus/* focusVisible */.b}) {
      outline: calc(${design_tokens/* strokeWidth */.H} * 1px) solid ${design_tokens/* accentFillFocus */.D8};
    }
  ...
  `.withBehaviors((0,match_media_stylesheet_behavior/* forcedColorsStylesheetBehavior */.vF)((0,css/* css */.i) `
      :host(:${style_focus/* focusVisible */.b}) {
        box-shadow: 0 0 0 calc(${design_tokens/* focusStrokeWidth */.vx} * 1px)
...
const ToolbarArrowKeyMap = Object.freeze({
    [key_codes/* ArrowKeys */.uf.ArrowUp]: {
        [Orientation.vertical]: -1
    },
    [key_codes/* ArrowKeys */.uf.ArrowDown]: {
        [Orientation.vertical]: 1
    },
    [key_codes/* ArrowKeys */.uf.ArrowLeft]: {
        [Orientation.horizontal]: {
            [localization/* Direction */.N.ltr]: -1,
            [localization/* Direction */.N.rtl]: 1
        }
    },
    [key_codes/* ArrowKeys */.uf.ArrowRight]: {
        [Orientation.horizontal]: {
            [localization/* Direction */.N.ltr]: 1,
            [localization/* Direction */.N.rtl]: -1
        }
 ...
 * @public
 */
class FoundationToolbar extends foundation_element/* FoundationElement */.I {
    constructor() {
        super(...arguments);
        /**
         ...
         * @internal
         */
        this.direction = localization/* Direction */.N.ltr;
        /**
     ...
     */
    get activeIndex() {
        observable/* Observable */.y$.track(this, 'activeIndex');
        return this._activeIndex;
    }
    set activeIndex(value) {
        if (this.$fastController.isConnected) {
            this._activeIndex = limit(0, this.focusableElements.length - 1, value);
            observable/* Observable */.y$.notify(this, 'activeIndex');
        }
    }
    slottedItemsChanged() {
        if (this.$fastController.isConnected) {
...
(0,tslib_es6/* __decorate */.gn)([
    (0,attributes/* attr */.Lj)({ attribute: 'aria-labelledby' })
], DelegatesARIAToolbar.prototype, "ariaLabelledby", void 0);
(0,tslib_es6/* __decorate */.gn)([
    (0,attributes/* attr */.Lj)({ attribute: 'aria-label' })
], DelegatesARIAToolbar.prototype, "ariaLabel", void 0);
(0,apply_mixins/* applyMixins */.e)(DelegatesARIAToolbar, aria_global/* ARIAGlobalStatesAndProperties */.v);
(0,apply_mixins/* applyMixins */.e)(FoundationToolbar, start_end/* StartEnd */.hW, DelegatesARIAToolbar);
/**
 * @public
 * @tagname jp-toolbar
 */
class Toolbar extends FoundationToolbar {
    connectedCallback() {
        super.connectedCallback();
        const parent = (0,composed_parent/* composedParent */.T)(this);
        if (parent) {
            design_tokens/* fillColor */.If.setValueFor(this, (target) => design_tokens/* neutralFillLayerRecipe */.ab
                .getValueFor(target)
                .evaluate(target, design_tokens/* fillColor */.If.getValueFor(parent)));
        }
    }
}
/**
...
/* harmony export */   e: () => (/* binding */ addJupyterLabThemeChangeListener)
/* harmony export */ });
/* unused harmony export applyJupyterTheme */
/* harmony import */ var _microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93484);
/* harmony import */ var _microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(76962);
/* harmony import */ var _microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(77727);
/* harmony import */ var _color_swatch_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(83571);
/* harmony import */ var _color_utilities_base_layer_luminance_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(79892);
/* harmony import */ var _color_utilities_is_dark_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(90859);
/* harmony import */ var _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(87206);
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
...
const tokenMappings = {
    '--jp-border-width': {
        ...
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .strokeWidth */ .H
    },
    '--jp-border-radius': {
        converter: intConverter,
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .controlCornerRadius */ .UW
    },
    [BASE_LAYOUT_COLOR]: {
        converter: (value, isDark) => {
            const parsedColor = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_1__/* .parseColor */ .lu)(value);
            if (parsedColor) {
                const hsl = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_2__/* .rgbToHSL */ .lw)(parsedColor);
                // Neutral luminance should be about 50%
                const correctedHSL = _microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_3__/* .ColorHSL */ .H.fromObject({
                    h: hsl.h,
                    s: hsl.s,
                    l: 0.5
                });
                const correctedRGB = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_2__/* .hslToRGB */ .hP)(correctedHSL);
                return _color_swatch_js__WEBPACK_IMPORTED_MODULE_4__/* .SwatchRGB */ .w.create(correctedRGB.r, correctedRGB.g, correctedRGB.b);
            }
            else {
                return null;
            }
        },
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .neutralColor */ .z4
    },
    '--jp-brand-color1': {
        converter: (value, isDark) => {
            const parsedColor = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_1__/* .parseColor */ .lu)(value);
            if (parsedColor) {
                ...
                const correctedHSL = _microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_3__/* .ColorHSL */ .H.fromObject({
                    ...
                    s: hsl.s,
                    l: hsl.l +
                        (direction * _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .accentFillHoverDelta */ .B2.getValueFor(document.body)) / 94.0
                });
                const correctedRGB = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_2__/* .hslToRGB */ .hP)(correctedHSL);
                return _color_swatch_js__WEBPACK_IMPORTED_MODULE_4__/* .SwatchRGB */ .w.create(correctedRGB.r, correctedRGB.g, correctedRGB.b);
            }
        ...
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .accentColor */ .z
    },
    '--jp-error-color1': {
        converter: (value, isDark) => {
            const parsedColor = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_1__/* .parseColor */ .lu)(value);
        ...
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .errorColor */ .S_
    },
    '--jp-ui-font-family': {
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .bodyFont */ .SV
    },
    '--jp-ui-font-size1': {
        token: _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .typeRampBaseFontSize */ .cS
    }
};
/**
 * Applies the current Jupyter theme to the toolkit components.
...
function applyJupyterTheme() {
    ...
    if (themeMode) {
        ...
        if (layoutColor) {
            const parsedColor = (0,_microsoft_fast_colors__WEBPACK_IMPORTED_MODULE_1__/* .parseColor */ .lu)(layoutColor);
            if (parsedColor) {
                isDark_ = (0,_color_utilities_is_dark_js__WEBPACK_IMPORTED_MODULE_5__/* .isDark */ ._)(_color_swatch_js__WEBPACK_IMPORTED_MODULE_4__/* .SwatchRGB */ .w.create(parsedColor.r, parsedColor.g, parsedColor.b));
                console.debug(`Theme is ${isDark_ ? 'dark' : 'light'} based on '${BASE_LAYOUT_COLOR}' value: ${layoutColor}.`);
            }
        }
    }
    _design_tokens_js__WEBPACK_IMPORTED_MODULE_0__/* .baseLayerLuminance */ .q2.setValueFor(document.body, isDark_ ? _color_utilities_base_layer_luminance_js__WEBPACK_IMPORTED_MODULE_6__/* .StandardLuminance */ .h.DarkMode : _color_utilities_base_layer_luminance_js__WEBPACK_IMPORTED_MODULE_6__/* .StandardLuminance */ .h.LightMode);
...
//# sourceMappingURL=4864.c22882a8feba283c53ca.js.map?v=c22882a8feba283c53ca